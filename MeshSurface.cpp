...
void Surface::Relocate(long size, void * p)
{	
	if (!p)
		return;
...
void RefMap::Relocate(long size, void * p)
{
	if (!p)
		return;
...
void SurfInfo::Relocate(long size, void * p)
{
	if (!p)
		return;
...
void SurfLayer::Relocate(long size, void * p)
{
	if (!p)
		return;
...
void UVMap::Relocate(long size, void * p)
{	
	if (!p)
		return;
...
void Image::Relocate(long size, void * p)
{
	if (!p)
		return;
...
void _DVMap::Relocate(long size, void * p)
{	
	if (!p)
		return;
